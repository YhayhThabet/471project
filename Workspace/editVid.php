...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="header">
        <div><!--the reel image-->
            <img id="img" src="img/movie-reel.png" alt="movie-reel" width="100"/>
        </div>
        ...
        <div id="nav">
            <ul><!--an unordered list of links to the various pages-->
                ...
                <li><a href="editVid.php" class="active">Edit Video</a></li>
                <li><a href="displayDetails.php">Display Details</a></li>
               <?php
                    ...
                    <div><!--genre selection-->
                        <label for="genreOptions">Genre: 
                            <select name="genreOptions" multiple="multiple" id="genreOptions">                                
                                ...
                                <option value="genre2">Horror</option>
                                <option value="genre3">Drama</option>
                            </select>
                        </label>
                    </div>
                    <div>
